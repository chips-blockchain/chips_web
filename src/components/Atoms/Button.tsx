...
const StyledButton = styled.button`
  ...
  background: ${props =>
    props.theme == "red"
      ? "linear-gradient(180deg, rgba(255, 17, 81, 0) 0%, rgba(255, 17, 81, 0.8) 0.01%, rgba(255, 66, 116, 0.9) 100%)"
      : props.theme == "blue"
      ? "linear-gradient(180deg, rgba(75, 171, 248, 0) 0%, rgba(73, 130, 244, 0.4) 0.01%, #4BABF8 100%)"
